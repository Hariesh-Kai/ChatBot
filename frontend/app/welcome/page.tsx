      ...
      <div className="mx-auto w-full max-w-5xl px-6 py-8">
        ...
        <div className="rounded-2xl border border-white/10 bg-[radial-gradient(circle_at_top_right,#1f2937_0%,#0f172a_35%,#0a0a0a_100%)] p-6 shadow-xl">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-xs text-gray-400">
                Signed in as {(user?.role || "user").toUpperCase()}.
              </p>
            </div>
            <Link
              href="/"
          ...
          <div className="mt-5 grid grid-cols-2 gap-3 sm:grid-cols-4">
            <Stat icon={LayoutDashboard} label="Dashboard" value="Ready" />
        ...
        <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
          ...
          {canAccessDevtools ? (
            ...
            >
              ...
              <div className="mt-1 text-xs text-gray-400">Manage users, models, runtime and diagnostics.</div>
            </Link>
          ) : (
            <div className="rounded-xl border border-white/10 bg-[#111] p-4 opacity-80">
              <div className="text-sm font-semibold">User Workspace</div>
              <div className="mt-1 text-xs text-gray-400">You have standard access. Developer tools are restricted.</div>
            </div>
          )}
        </div>
      </div>
